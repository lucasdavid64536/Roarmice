...
class ModoPwet:
    ...
    def makeReport(this, playerName, type, comments):
        ...
        this.server.sendModMessage(7, "<br>[<V>M O D O P W E T <BL>]<br>Novo report: Usuario reportado: [<J>"+playerName+"<BL>]<br><J>PRESSIONE <font color='#ffffff'>M</font> <J>PARA VER<BL>")
